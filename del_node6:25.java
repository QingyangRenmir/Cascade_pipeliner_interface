...
//                    cnode.managedProperty().bind(cnode.visibleProperty());
//                }
//            };
            // when button is pressed
//            cnode.setOnAction(event);
...
//                                VBox popbox= new VBox(20);
                    ...
                    if (db.getString().equals("D")) {
                        ...
                        // !!! set initial position for dlbl according to dnod
                        layoutX= dnod.getLayoutX();
                        layoutY= dnod.getLayoutY();
                        ...
                        // !!! set right click for delete dnod tgt with dlbl
                        dnod.setOnMousePressed(e -> {
                            if (e.getButton() == MouseButton.SECONDARY) {
                                System.out.println("Want to delete?");
                            }
